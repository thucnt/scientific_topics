...
import edu.uit.snmr.view.SnmrFrame;
...
public class DatasetConfDialog extends JDialog {
	...
	private JButton jButton_analyze;

        public DatasetConfDialog(){    
        }
	...
	public DatasetConfDialog(final SnmrFrame parent) {
		...
		try {
			from = format.parse(GUIUtils.getProperty("from"));
			to = format.parse(GUIUtils.getProperty("to"));
		} catch (Exception ex) {
		...
		jTextField_selectDataSet.setText(GUIUtils.getProperty("dataset"));
		final JTextField jTextField_selectUser = new JTextField(20);
		jTextField_selectUser.setText(GUIUtils.getProperty("users"));
		final JTextField jTextField_resultDir = new JTextField(20);
		jTextField_resultDir.setText(GUIUtils.getProperty("resultDir"));
		final JTextField jTextField_topics = new JTextField(20);
		jTextField_topics.setText(GUIUtils.getProperty("topics"));
		final JTextField jTextField_from = new JTextField(20);
		jTextField_from.setText(GUIUtils.getProperty("from"));
		final JTextField jTextField_to = new JTextField(20);
		jTextField_to.setText(GUIUtils.getProperty("to"));
		final JTextField jTextField_alpha = new JTextField(20);
		jTextField_alpha.setText(GUIUtils.getProperty("alpha"));
		final JTextField jTextField_beta = new JTextField(20);
		jTextField_beta.setText(GUIUtils.getProperty("beta"));
		final JTextField jTextField_burnIn = new JTextField(20);
		jTextField_burnIn.setText(GUIUtils.getProperty("burnIn"));
		final JTextField jTextField_sampling = new JTextField(20);
		jTextField_sampling.setText(GUIUtils.getProperty("sampling"));
		...
		jButton_save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean result = GUIUtils.saveProperties(dataset, users,
						...
						sampling);
				if (!result)
					JOptionPane.showMessageDialog(DatasetConfDialog.this,
							GUIUtils.get("fail"));
				dispose();
			}
		});
