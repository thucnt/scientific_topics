...
public class TopicImportDialog extends JDialog {
	...
	public TopicImportDialog(SnmrFrame parent) {
		this.parent = parent;
	...
	private void initComponents() {
		...
		jButton_import.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (result) {
					parent.loadImportedTopic(GUIUtils.convertToTreeNode(top));
					DatasetPropertiesConfig.getInstance().setTrainningTopicImported(true);					
...
//					JOptionPane.showMessageDialog(GUI_Tree.this, "Successful");
	...
	public MutableTreeNode getTopNode() {
		return GUIUtils.convertToTreeNode(top);
	}
}
