package edu.uit.snmr.topicmodeling.art.inference;
...
public class TopicInferencer implements Serializable {
	...
	public TopicInferencer (int[][] typeTopicCounts, int[] tokensPerTopic, 
	 ...
	 */
	public double[] getSampledDistribution(FeatureSequence tokens, int numIterations,
