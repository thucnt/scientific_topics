 ...
 *
 */
public class CopyOfRandomGenerator {
	...
	private static CopyOfRandomGenerator instance;
	
	private CopyOfRandomGenerator () {
		this.mtRandom = new MersenneTwister();
	}
	
	public static CopyOfRandomGenerator getInstance() {
		if (instance == null) 
		{
			instance = new CopyOfRandomGenerator();
		}
		return instance;
	}
	...
	public static void main(String[] args) {
		...
		CopyOfRandomGenerator instance = CopyOfRandomGenerator.getInstance();
		instance.setSeed(1);		
