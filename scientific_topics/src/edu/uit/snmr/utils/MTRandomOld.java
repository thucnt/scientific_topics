 ...
 * 
 */
public class MTRandomOld extends Random {
	 ...
	 * behaviour.
	 */
	public MTRandomOld(boolean compatible) {
		super(0L);
		compat = compatible;
